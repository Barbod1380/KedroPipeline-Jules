from .CONSTS_sari.CONSTS_sari import RULES, REPLACEMENT_DICT, ABBREVIATION_DICT
from .CONSTS_sari.CONSTS_sari import KEYWORDS_TO_CUT_BEFORE, KEYWORDS_TO_CUT_AFTER, PREFIX_TO_REMOVE
from .CONSTS_sari.CONSTS_sari import graph_model
...
def preprocess_address(input_string: str) -> str:
    ...
    input_string = input_string.replace(" خیابان ساری ", " خیابان_ساری ")
